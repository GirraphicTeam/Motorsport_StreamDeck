...
{
    [PluginActionId("com.hardenduro.streamdeck.bikenumdisplay")]
    public class BikeNumDisplay : PluginBase
    {
        private class Rider
        {
            public int BikeNum;
        ...
        public BikeNumDisplay(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
        ...
        public override void KeyPressed(KeyPayload payload)
        {
            ...
            using (StreamReader file = File.OpenText(@"CurrentNumber.txt"))
            {
                ...
                contents = contents + settings.CarPosition;
        ...
        {
            await Connection.SetTitleAsync($"{settings.CarPosition}");
        }
