...
{
    [PluginActionId("com.motorsport.streamdeck.quali")]
    public class Qualies : PluginBase
    {
        ...
        public Qualies(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
        ...
        public override void KeyPressed(KeyPayload payload)
        {
            ...
            if (carNum > 0)
            {
                ...
                //}
                //JsonFiles.SaveJSONList("QSelected", SelectedCars);
            }
